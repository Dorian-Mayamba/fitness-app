...
import uk.ac.aston.cs3mdd.fitnessapp.adapters.EditExerciseAdapter;
...
import uk.ac.aston.cs3mdd.fitnessapp.observers.DialogExercisesObserver;
...
public class EditExerciseDialogFragment extends DialogFragment {
    ...
    public interface EditDialogListener{
        void onEditConfirm(DialogFragment fragment, Exercise exercise, uk.ac.aston.cs3mdd.fitnessapp.serializers.Exercise chosenExercise);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final Observer<List<uk.ac.aston.cs3mdd.fitnessapp.serializers.Exercise>> exercisesObserver
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        ExerciseItemClickListener exerciseItemClickListener = new ExerciseItemClickListener() {
            ...
            @Override
            public void onEditExerciseClick(uk.ac.aston.cs3mdd.fitnessapp.serializers.Exercise newExercise) {
    ...
    private CharSequence[] toCharSequence(List<uk.ac.aston.cs3mdd.fitnessapp.serializers.Exercise> exercises){
